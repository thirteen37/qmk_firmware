...
[_RS] = LAYOUT( /* [> RAISE <] */
  ...
  TG(_LW), KC_INS,  KC_TRNS, KC_TRNS, KC_DELT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DOT, KC_0, KC_TRNS ),
/*
...
[_LW] = LAYOUT( /* [> LOWER <] */
  ...
  KC_VOLD, KC_VOLU, KC_MUTE, KC_NO,   RESET,                     KC_NO,   KC_F1,   KC_F2,   KC_F3,   KC_F12  ,
  KC_NO,   KC_CAPS, TO(_QW), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PSCR, KC_SLCK, KC_PAUS ),
/* Super Duper */
