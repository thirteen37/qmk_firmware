...
#define TH_LAYER_MASK (layer_state_t)((1UL<<TH_WIN) | (1UL<<TH_MAC) | (1UL<<TH_PC) | (1UL<<TH_LYSP) | (1UL<<TH_VILE))
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [QWERT] = LAYOUT_pretty(
    KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,         KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_PSCR,  KC_SCRL,  KC_PAUS,  TG(EMBED),MO(PROG),
  ...
  [TH_LYSP] = LAYOUT_pretty(
    ...
    _______,         _______,  _______,  _______,  _______,  _______,                                                                   _______,  _______,  _______,  _______,  _______,  _______,
    _______,         _______,  _______,  _______,  _______,  _______,                                                                   _______,  _______,  _______,  _______,  _______,  _______,
    HYPR_T(KC_CAPS), _______,  _______,  _______,  _______,  _______,                                                                   _______,  _______,  _______,  _______,  _______,  _______,
    _______,         _______,  _______,  _______,  _______,  _______,                                                                   _______,  _______,  _______,  _______,  _______,  _______,
                     _______,  _______,  _______,  _______,                                                                                       _______,  _______,  _______,  _______,
                                                             KC_LCTL,  KC_LALT,                                               KC_RGUI,  KC_RCTL,
                                                                       KC_HOME,                                               RALT_T(KC_PGUP),
                                                   KC_BSPC,  KC_DEL,   KC_END,                                                KC_PGDN,  KC_ENTER, KC_SPC
                            ),
  ...
  [TH_VILE] = LAYOUT_pretty(
    ...
    _______,        _______,  _______,  _______,  _______,  _______,                                                                   _______,  _______,  _______,  _______,  _______,  _______,
    _______,        _______,  _______,  _______,  _______,  _______,                                                                   _______,  _______,  _______,  _______,  _______,  _______,
    HYPR_T(KC_ESC), _______,  _______,  _______,  _______,  _______,                                                                   _______,  _______,  _______,  _______,  _______,  _______,
    _______,        _______,  _______,  _______,  _______,  _______,                                                                   _______,  _______,  _______,  _______,  _______,  _______,
                    _______,  _______,  _______,  _______,                                                                                       _______,  _______,  _______,  _______,
                                                            KC_LCTL,  KC_LALT,                                               KC_RGUI,  KC_RCTL,
                                                                      KC_HOME,                                               RALT_T(KC_PGUP),
  ...
  [EMBED] = LAYOUT_pretty(
    ...
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,                                                                   XXXXXXX,  KC_NUM,   KC_PEQL,  KC_PSLS,  KC_PAST,  XXXXXXX,
  ...
  [PROG] = LAYOUT_pretty(
    QK_MAKE,  XXXXXXX,  XXXXXXX,  QWERTY,   DVORAK,   MAC,      PC,       WIN,      CK_TOGG,       QK_BOOT,  DM_RSTP,OSL(MACREC),OSL(MACPLY),XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    _______,  _______,  _______,  _______,  _______,  _______,                                                                     _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,                                                                     _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,                                                                     _______,  _______,  _______,  _______,  _______,  _______,
  ...
  [PROGS] = LAYOUT_pretty(
    _______,  _______,  _______,  COLEMAK,  WORKMAN,  LYSP,     VILE,     _______,  AU_TOGG,       EE_CLR,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,                                                                   _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,                                                                   _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,                                                                   _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,                                                                   _______,  _______,  _______,  _______,  _______,  _______,
