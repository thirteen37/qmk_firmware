...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_ergodox(
		 ...
		 MO(FNKY), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT,
		 ...
		 // Right hand
		     ...
		     RGUI_T(KC_NO), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
		                             KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, TG(MSNM),
  ...
  [FNKY] = LAYOUT_ergodox(
		 ...
		 // Right hand
		     ...
		     KC_TRNS, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, KC_F12,
		              KC_MPLY, KC_MSTP, KC_MPRV, KC_MNXT, KC_NO,  KC_TRNS,
		     KC_TRNS, KC_MUTE, KC_VOLD, KC_VOLU, KC_NO,   KC_NO,  KC_TRNS,
		                       KC_PSCR, KC_SLCK, KC_PAUS, KC_NO,  TG(GAME),
		 KC_TRNS, KC_TRNS,
		 KC_TRNS,
  ...
  [GAME] = LAYOUT_ergodox(
		 ...
		 KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		 KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		 TG(GAMEFN), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		                                              KC_TRNS, KC_TRNS,
		                                                       KC_TRNS,
		     ...
		     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		              KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TG(GAME),
		 KC_TRNS, KC_TRNS,
		 KC_TRNS,
		 KC_TRNS, KC_TRNS, KC_DEL
  ),

  [GAMEFN] = LAYOUT_ergodox(
		 // Left hand
		 KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		 KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		 KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
